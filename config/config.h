 ...
 */
char font[] = "Source Code Pro,FontAwesome,Symbola,NanumGothicCoding,Sazanami Gothic,cwTeXYen:pixelsize=15:antialias=true:autohint=true";
int borderpx = 2;
